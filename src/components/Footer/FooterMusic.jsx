  ...
  export default function FooterMusic() {
    ...
    return (
      <>
        ...
        <footer
          className={`fixed bottom-0 w-full h-[72px] rounded-3xl bg-(--bg-light-footer) dark:bg-(--bg-dark-footer) dark:text-white flex items-center justify-between px-2 sm:px-4 md:px-6 ring drop-shadow-3xl-footer ring-gray-900/5 transform transition-transform duration-300 ${
        ...
        >
          ...
          <div className="flex items-center justify-end space-x-2 sm:space-x-3 min-w-[120px]">
            <button className={btnClass} onClick={toggleVolumeHandler}>
